...
function FloatingPaths({ position }: { position: number }) {
  ...
  return (
    <div className="absolute inset-0 pointer-events-none">
      <svg className="h-full w-full text-slate-700/70 dark:text-white/70" viewBox="0 0 696 316" fill="none">
        ...
        {paths.map((path) => (
          <motion.path
            ...
            strokeOpacity={0.08 + path.id * 0.014}
...
export function BackgroundPathsBackdrop() {
  return (
    <div className="pointer-events-none absolute inset-0 overflow-hidden">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,rgba(96,165,250,0.08),transparent_26%),radial-gradient(circle_at_bottom,rgba(129,140,248,0.08),transparent_28%),linear-gradient(180deg,#020617_0%,#020617_28%,#0f172a_100%)]" />
